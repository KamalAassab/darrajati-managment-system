        ...
        <div className="glass-panel rounded-3xl p-4 md:p-5 border-white/[0.03] hover:border-white/[0.08] transition-all duration-500 h-full">
            ...
            <div className="space-y-2">
                {scooters.map((scooter, index) => (
                    <div
                        key={scooter.id}
                        className="flex items-center justify-between gap-3 p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-orange/20 hover:bg-white/[0.04] transition-all group"
                    >
                        {/* Left: Rank + Name */}
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                            <div className="w-6 h-6 rounded-lg bg-orange/10 flex items-center justify-center flex-shrink-0">
                                <span className="text-[10px] font-black text-orange">{index + 1}</span>
                            </div>
                            <span className="text-sm font-bold text-white truncate group-hover:text-orange transition-colors">
                                {scooter.name}
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-4 flex-shrink-0">
                            ...
                            <div className="text-right min-w-[80px]">
                                <p className="text-sm font-black text-orange font-outfit">{formatMAD(scooter.revenue)}</p>
