...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative bg-black overflow-hidden font-alexandria">
            {/* Background elements */}
            ...
            <div className="w-full max-w-md relative z-10 px-4">
                <div className="glass-panel-dark rounded-3xl p-8 md:p-10 orange-glow-border">
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-4xl font-anton tracking-tighter text-white mb-2 uppercase italic text-glow-orange">
